...
public class Xor extends BinaryExpression implements Expression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Xor(getE1().assign(var, expression), getE2().assign(var, expression));
    }

    @Override
    public Expression nandify() {
        return new Nand(new Nand(getE1().nandify(), new Nand(getE1().nandify(), getE2().nandify())),
                new Nand(getE2().nandify(), new Nand(getE1().nandify(), getE2().nandify())));
    }
    ...
    public Expression norify() {
        return new Nor(
                new Nor(
                new Nor(getE1().norify(), getE1().norify()),
